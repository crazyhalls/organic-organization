...
Você pode a qualquer momento deixar de energizar [Papéis](#2-1-papeis) em um ou mais [Círculos](#2-2-circulos), a não ser que você tenha de outra forma acordado com o [Elo Externo](#4-1-elo-externo) ou outro processo de [Energização](#5-energizacao-de-papeis-definidos).
...
O [Papel](#2-1-papeis) do "Elo Externo" possui a seguinte definição inicial:
...
Todos e apenas os [Membros do Círculo](#2-4-membros-do-circulo) são elegíveis para energizar os [Papéis Essenciais Eleitos](#4-5-papeis-essenciais-eleitos). Ainda assim, o [Parceiro](#1-2-parceiros) que energiza o [Papel](#2-1-papeis) de [Elo Externo](#4-1-elo-externo) não pode energizar o [Papel](#2-1-papeis) de [Facilitador](#4-3-facilitador) ou [Elo Interno](#4-4-elo-interno) no mesmo [Círculo](#2-2-circulos).

### 4.5.2 Eleições

Qualquer [Membro do Círculo](#2-4-membros-do-circulo) pode solicitar "Eleições" para os [Papéis Essenciais Eleitos](#4-5-papeis-essenciais-eleitos). O processo de Eleição é feito inicialmente por maioria simples para escolher uma pessoa que será nomeada e em seguida faz-se o uso de consentimento para efetivar a nomeação. A [Estrutura Organizacional](#2-estrutura-organizacional) pode definir em detalhes como e em que condições este processo deve ser facilitado.
